...
function update_database($page_info){
    ...
    foreach ($page_info as $item) {
        ...
        (`sysid`,`supplier_id`,`page_id`,`row`,`lib_id`,`lib_title`,`lib_text`,`img_url1`,`img_url2`,`img_url3`,`img_url4`,`item_url1`,`item_url2`,`item_url3`,`item_url4`,`lib_num`,`lib_num_max`)
        values('".$item['sysid']."',".$item['supplier_id'].",".$item['page_id'].",".$item['row'].",".$item['lib_id'].",'".$item['lib_title']."','".$item['lib_text']."',".
            "'".$item['img_url1']."','". $item['img_url2']."','".$item['img_url3']."','".$item['img_url4']."','". $item['item_url1']."','".$item['item_url2']."','".$item['item_url3']."','".$item['item_url4']."',". $item['lib_num'].",".$item['lib_num_max'].")";
